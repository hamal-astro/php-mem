  ...
  <form name="input_form" method="post" enctype="multipart/form-data" autocomplete="off" action="pg/member_process.php">
    ...
    <div class="d-flex mt-3 gap-2 justify-content-between">
      <div class="flex-grow-1">
        ...
        <input type="text" class="form-control" readonly name="addr1" id="f_addr1" placeholder="">
      </div>
      <div class="flex-grow-1">
    ...
    <div class="mt-3 d-flex gap-5">
      ...
      <img src="images/Unknown_person.jpg" id="f_preview" class="w-25" alt="profile image">
    </div>
